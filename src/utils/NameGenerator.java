...
public abstract class NameGenerator {
	...
	private static List<String> lastName = Arrays.asList("le Grand", "le Bon", "le Bref", "le Simple", "le Petit", "le Gentil", "le Moine", "l’Éveillé", "le Nez", "le Bleu", "le Maigre", "le Bègue", "le Moyen", "l’Édenté", "le Duc", "le Preux", "Dupaissay", "McNuggets", "de Bordeaux", "du Chemin", "de la Rue", "aux Grands Pieds", "le Vaillant", "le Gueux", "le Faible", "le Fort", "le Fol", "de la Bouche-en-Biais", "du Mollard", "du Froc", "du Trône", "l’Ahuri", "l’Envieux", "le Brun", "le Goinfre", "le Bâtard", "de Nice", "d’Hossegor", "le Paresseux", "le Grincheux", "le Râleur", "le Pingre", "l’Estropié", "le Borgne", "le Chauve", "le Muet", "le Sourd", "l’Ivrogne", "l’Éventreur", "l’Allemand", "l’Espagnol", "le Breton", "l’Empereur", "l’Évêque", "le Fignard", "le Dégénéré", "la Terreur");   /** List of last names. */
