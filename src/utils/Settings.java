...
public abstract class Settings {
	...
	public static double BOARD_CELL_STYLE_HEIGHT = 24; // in pixels
	public static double BOARD_CELL_STYLE_WIDTH = 24; // in pixels
	public static int BOARD_DIM_HEIGHT = 32; // in cells
	public static int BOARD_DIM_WIDTH = 48; // in cells
	public static int BOARD_FIRST_TURN = 1;
	...
	public static double BOARD_STYLE_LINES_WIDTH = 1.; // in pixels
	...
	public static double CASTLE_STYLE_STROKE_WIDTH = 4.; // in pixels
	public static double CASTLE_STYLE_CASTLE_HEIGHT = BOARD_CELL_STYLE_HEIGHT * .8; // in pixels
	...
	public static int ENTITY_CATAPULT_SPEED = 1; // in cells/turn
	public static Color ENTITY_CATAPULT_STYLE_COLOR = Color.rgb(100, 50, 20);
	public static double ENTITY_CATAPULT_STYLE_HEIGHT = BOARD_CELL_STYLE_HEIGHT * .12; // in pixels
	public static double ENTITY_CATAPULT_STYLE_WIDTH = BOARD_CELL_STYLE_WIDTH * .3; // in pixels
	...
	public static int ENTITY_KNIGHT_SPEED = 6; // in cells/turn
	public static Color ENTITY_KNIGHT_STYLE_COLOR = Color.rgb(170, 170, 190);
	public static double ENTITY_KNIGHT_STYLE_HEIGHT = BOARD_CELL_STYLE_HEIGHT * .14; // in pixels
	public static double ENTITY_KNIGHT_STYLE_WIDTH = BOARD_CELL_STYLE_WIDTH * .05; // in pixels
	...
	public static int ENTITY_PIKEMAN_SPEED = 2; // in cells/turn
	public static Color ENTITY_PIKEMAN_STYLE_COLOR = Color.rgb(180, 40, 0);
	public static double ENTITY_PIKEMAN_STYLE_HEIGHT = BOARD_CELL_STYLE_HEIGHT * .14; // in pixels
	public static double ENTITY_PIKEMAN_STYLE_WIDTH = BOARD_CELL_STYLE_WIDTH * .05; // in pixels
	...
	public static double WINDOW_DEFAULT_WIDTH = 1280; // in pixels
	public static double WINDOW_MIN_HEIGHT = 400; // in pixels
	public static double WINDOW_MIN_WIDTH = 600; // in pixels
